...
const Signup = () => {
  ...
  const verifyPhoneOtp = async () => {
    const res = await fetch("https://inventory-management-ero4.onrender.com/verify-otp", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  const submit = async (e) => {
    ...
    setLoading(true);
    const res = await fetch("https://inventory-management-ero4.onrender.com/signup", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
