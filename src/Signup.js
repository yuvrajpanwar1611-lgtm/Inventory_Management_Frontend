...
//     const res = await fetch("https://inventory-management-ero4.onrender.com/verify-email-otp", {
//       method: "POST",
//       headers: { "Content-Type": "application/json" },
...
//     const res = await fetch("https://inventory-management-ero4.onrender.com/send-otp", {
//       method: "POST",
//       headers: { "Content-Type": "application/json" },
...
const Signup = () => {
  const API = "https://inventory-management-ero4.onrender.com";
  ...
  const verifyEmailOtp = async () => {
    const res = await fetch(`${API}/verify-email-otp`, {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({ email: form.email, otp: Number(emailOtp) }),
    });
  ...
  const verifyPhoneOtp = async () => {
    const res = await fetch(`${API}/verify-otp`, {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({ mobile: form.phone, otp: Number(phoneOtp) }),
    });
